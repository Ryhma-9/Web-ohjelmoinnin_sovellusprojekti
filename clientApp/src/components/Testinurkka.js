...
export default function Testinurkka() {
  ...
  return (
    <div className='payment'>
      ...
      <div>
        <br></br>
        <label>Input pruduct picture:</label>
        <br></br>
        <input type="file"
          name="productPicture"
          accept=".jpg, .jpeg, .png"
        ...
        <br></br>
        <label>Picture must be in jpg or png format</label>
        <br></br>
        <button onClick={ onPictureUpload }>Upload picture</button>
      </div>
      <br></br><br></br><br></br>
