  ...
  return (
    <div>
      ...
      <div className="header">
        ...
        <Routes>
          {/* <Route path="/loginview" element={ <LoginView trigger={showLoginView} setTrigger={setShowLoginView} />}/>
          <Route path="/signupview" element={ <SignUpView trigger={showSignUpView} setTrigger={setShowSignUpView}/>}/> */}
